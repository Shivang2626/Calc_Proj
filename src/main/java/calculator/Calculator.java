...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        double n1, n2;
        do {
            System.out.println("Using Scientific Calculator with the help of DevOps. \n Choose operation:");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    System.out.println(n1+ "power of "+n2+" is : " + calculator.power(n1, n2));
                    System.out.println("\n");
                    break;
                case 4:
                    // Natural log
    ...
    public double power(double n1, double n2) {
        logger.info("[POWER - " + number1 + " RAISED TO] " + n2);
    ...
    public double naturalLog(double n1) {
        ...
        try {
            ...
            if (n1 <0 ) {
                result = Double.NaN;
                throw new ArithmeticException("Case of 0/0");
            }
            else {
                result = Math.log(n1);
            }
